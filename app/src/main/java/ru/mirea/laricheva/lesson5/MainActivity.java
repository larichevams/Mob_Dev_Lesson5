package ru.mirea.laricheva.lesson5;
...
import ru.mirea.laricheva.lesson5.databinding.ActivityMainBinding;
        ...
        implements SensorEventListener
{
    ...
    public void onSensorChanged(SensorEvent event) {
        if (event.sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
            ...
            Log.d("accelerometerSensor", valueAzimuth + " " + valuePitch + " " + valueRoll);
        }
    }
